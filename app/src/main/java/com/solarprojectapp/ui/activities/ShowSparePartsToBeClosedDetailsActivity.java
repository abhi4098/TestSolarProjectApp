...
public class ShowSparePartsToBeClosedDetailsActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   String  sparePartName,sparePartCreatedDate,sparePartBrand,sparePartId,sparePartPrice,sparePartRequestedPrice,sparePartRequestedQuantity,sparePartStatusName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ShowSparePartsToBeClosedDetailsActivity.this;
        ButterKnife.bind(this);
        ivBackIcon.setOnClickListener(this);
        tvAppTitle.setText("SPARE PARTS TO BE CLOSED TODAY DETAILS");
