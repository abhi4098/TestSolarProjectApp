...
public class ClosureComplaintListActivity extends AppCompatActivity implements View.OnClickListener {
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ClosureComplaintListActivity.this;
        ButterKnife.bind(this);
        ivBackIcon.setOnClickListener(this);
        tvAppTitle.setText("CLOSURE COMPLAINTS");
    ...
    private void getClosedComplaints() {
        LoadingDialog.showLoadingDialog(this,"Loading...");
        Call<NewComplaintResponse> call = UserCompaintListAdapter.userNewComplaintList("closedcomplainlist");
    ...
    private void setClosedComplaints(Response<NewComplaintResponse> response) {
        ...
        complaintAdapter = new ComplaintAdapter(this, R.layout.layout_new_complaint_list, R.id.complaint_name, complaintList, "ClosureComplaintListActivity");
