...
public class OpenComplaintListActivity extends AppCompatActivity implements View.OnClickListener {
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = OpenComplaintListActivity.this;
        ButterKnife.bind(this);
        ivBackIcon.setOnClickListener(this);
        tvAppTitle.setText("OPEN COMPLAINTS");
    ...
    private void setOpenComplaints(Response<NewComplaintResponse> response) {
        ...
        complaintAdapter = new ComplaintAdapter(this, R.layout.layout_new_complaint_list, R.id.complaint_name, complaintList, "OpenComplaintListActivity");
